package svnavigatoru.domain.forum;
...
public class Thread implements Serializable, Comparable<Thread> {
	...
	/**
	 * Gets the {@link Contribution} which has been saved the latest time among
	 * all {@link Contribution}s of this {@link Thread}.
	 */
	...
	/**
	 * Sorts according to the last saved {@link Contribution}s returned by the
	 * method <code>getLastSavedContribution</code>.
	 */
