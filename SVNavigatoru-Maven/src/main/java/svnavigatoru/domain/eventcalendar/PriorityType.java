package svnavigatoru.domain.eventcalendar;
...
public enum PriorityType {
	...
	/**
	 * This method is based on the method <code>valueOf(String)</code>. The
	 * difference is that the first parameter is not the name of the type, but
	 * the result of localization of its <code>localizationCode</code>.
	 */
