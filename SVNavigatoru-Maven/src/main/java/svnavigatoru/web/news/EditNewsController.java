...
import svnavigatoru.service.news.EditNews;
import svnavigatoru.service.news.EditNewsValidator;

@Controller
public class EditNewsController extends NewEditNewsController {

	private static final String REQUEST_MAPPING_BASE_URL = EditNewsController.BASE_URL + "existujici/{newsId}/";
	/**
