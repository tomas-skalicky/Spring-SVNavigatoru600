...
import svnavigatoru.service.forum.threads.NewThread;
import svnavigatoru.service.forum.threads.NewThreadValidator;
...
public class NewThreadController extends NewEditThreadController {
	...
	/**
	 * If values in the form are OK, the new thread is stored to the repository.
