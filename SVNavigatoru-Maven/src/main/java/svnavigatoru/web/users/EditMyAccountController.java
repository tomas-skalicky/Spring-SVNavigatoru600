package svnavigatoru.web.users;
...
import svnavigatoru.service.users.UpdateUserData;
import svnavigatoru.service.users.UpdateUserDataValidator;
...
/**
 * The controller bound to the <i>user-account.jsp</i> and
 * <i>user-administration.jsp</i> form. For more details about the concepts used
 * here, see the <i>ForgottenPasswordController</i> controller.
 * 
...
public class EditMyAccountController extends PrivateSectionMetaController {
	...
	/**
	 * Initializes the form after the modified data were successfully saved to a
	 * repository.
	 */
	...
	/**
	 * If values in the form are OK, update date of the current {@link User}.
	...
	public String processSubmittedForm(@ModelAttribute(EditMyAccountController.COMMAND) UpdateUserData command,
		...
		try {
			...
			model.addAttribute(Configuration.REDIRECTION_ATTRIBUTE, EditMyAccountController.BASE_URL + "ulozeno/");
