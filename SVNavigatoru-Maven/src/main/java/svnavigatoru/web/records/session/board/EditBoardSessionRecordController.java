...
import svnavigatoru.web.records.session.EditRecordController;
...
public class EditBoardSessionRecordController extends EditRecordController {
	...
	public EditBoardSessionRecordController(SessionRecordDao recordDao, EditSessionRecordValidator validator,
		...
		super(EditBoardSessionRecordController.BASE_URL, new PageViews(), SessionRecordType.SESSION_RECORD_OF_BOARD,
	...
	@Override
	@RequestMapping(value = EditBoardSessionRecordController.BASE_URL + "{recordId}/ulozeno/",
