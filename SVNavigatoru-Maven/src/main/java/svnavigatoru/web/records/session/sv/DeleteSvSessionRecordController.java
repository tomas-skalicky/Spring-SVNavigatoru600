...
import svnavigatoru.web.records.session.DeleteRecordController;
...
public class DeleteSvSessionRecordController extends DeleteRecordController {
	...
	public DeleteSvSessionRecordController(SessionRecordDao recordDao, MessageSource messageSource) {
		super(DeleteSvSessionRecordController.BASE_URL, new PageViews(), SessionRecordType.SESSION_RECORD_OF_SV,
				recordDao, messageSource);
	}

	@Override
	@RequestMapping(value = DeleteSvSessionRecordController.BASE_URL + "existujici/{recordId}/smazat/",
