...
import svnavigatoru.service.records.otherdocuments.EditRecord;
import svnavigatoru.service.records.otherdocuments.EditRecordValidator;
import svnavigatoru.web.records.otherdocuments.EditDocumentController;
...
public class EditContractDocumentController extends EditDocumentController {
	...
	public EditContractDocumentController(OtherDocumentRecordDao recordDao, EditRecordValidator validator,
		...
		super(EditContractDocumentController.BASE_URL, new PageViews(), OtherDocumentRecordType.CONTRACT, recordDao,
				validator, messageSource);
	}

	@Override
	@RequestMapping(value = EditContractDocumentController.BASE_URL + "{recordId}/", method = RequestMethod.GET)
	...
	@Override
	@RequestMapping(value = EditContractDocumentController.BASE_URL + "{recordId}/ulozeno/", method = RequestMethod.GET)
