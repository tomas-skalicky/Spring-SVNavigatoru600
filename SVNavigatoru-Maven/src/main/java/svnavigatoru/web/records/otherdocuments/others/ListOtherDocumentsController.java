...
@Controller
public class ListOtherDocumentsController extends ListDocumentsController {
	 ...
	 */
	@Autowired
	public ListOtherDocumentsController(OtherDocumentRecordDao recordDao, MessageSource messageSource) {
		super(ListOtherDocumentsController.BASE_URL, new PageViews(), OtherDocumentRecordType.OTHER, recordDao,
				messageSource);
	}
