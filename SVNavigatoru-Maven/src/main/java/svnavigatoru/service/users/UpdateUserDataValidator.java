...
import svnavigatoru.service.util.PhoneNumber;

/**
 * Validates the data of the current {@link User} filled in in the
...
public class UpdateUserDataValidator implements Validator {
	...
	/**
	 * Checks whether the given <code>password</code> and its
	 * <code>confirmation</code> are equal and whether they represent the valid
	 * password. If both of them are blank, the parameters are OK.
	 * 
	 * @param password
	...
	/**
	 * Checks whether the given <code>email</code> is in the valid format unless
	 * it is blank.
	 */
	...
	/**
	 * Checks whether the given <code>phone</code> number is in the valid format
	 * unless it is blank.
	 */
