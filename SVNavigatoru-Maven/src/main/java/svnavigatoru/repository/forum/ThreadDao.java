...
public interface ThreadDao {
	...
	/**
	 * Returns a {@link Thread} stored in the repository which has the given
	 * <code>ID</code>.
	 */
	...
	/**
	 * Updates the given <code>thread</code> in the repository. The old version
	 * of the <code>thread</code> should be already stored there.
	 */
