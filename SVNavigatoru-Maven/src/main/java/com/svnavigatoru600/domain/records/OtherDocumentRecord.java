...
public class OtherDocumentRecord extends DocumentRecord {
	...
	/**
	 * Types of this {@link OtherDocumentRecord}. The record can be of more
	 * types at the same time.
	 */
	private Set<OtherDocumentRecordTypeRelation> types;
	/**
	 * {@link Date} when this {@link OtherDocumentRecord} has been created. The
	 * date is set by automatically by the application.
	 */
	@DateTimeFormat(style = "LS")
	private Date creationTime;
	/**
	 * {@link Date} when this {@link OtherDocumentRecord} has been last saved to
	 * the repository. The date is set by automatically by the application.
	 */
	@DateTimeFormat(style = "LS")
