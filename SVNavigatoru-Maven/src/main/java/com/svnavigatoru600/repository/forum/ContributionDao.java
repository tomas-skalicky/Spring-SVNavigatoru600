...
public interface ContributionDao {
     ...
     * <p>
     * Does not persist neither new {@link com.svnavigatoru600.domain.forum.Thread Thread} object, nor new
     * {@link com.svnavigatoru600.domain.users.User User} one, but links to already-existing repository
     * records. It means that <code>contribution</code>'s {@link Contribution#getThread() thread} and
     * {@link Contribution#getAuthor() author} must have been already stored in the repository; otherwise, an
     * exception is thrown.
     */
