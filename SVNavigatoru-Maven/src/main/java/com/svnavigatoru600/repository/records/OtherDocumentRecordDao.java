...
public interface OtherDocumentRecordDao extends DocumentRecordDao {
    ...
    /**
     * Stores the given {@link OtherDocumentRecord} to the repository. If there is already a
     * {@link OtherDocumentRecord} with the same
     * {@link com.svnavigatoru600.domain.records.AbstractDocumentRecord#getFileName() filename}, throws an
     * exception.
     * 
