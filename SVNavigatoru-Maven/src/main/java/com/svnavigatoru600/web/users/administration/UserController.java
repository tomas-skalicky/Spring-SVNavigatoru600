...
public abstract class UserController extends PrivateSectionMetaController {
	...
	/**
	 * Gets a {@link Map} which for each {@link AuthorityType} (more precisely
	 * its ordinal) contains an appropriate ID of its checkbox.
	 */
	...
	/**
	 * Gets a {@link Map} which for each {@link AuthorityType} (more precisely
	 * its ordinal) contains an appropriate localized title of its checkbox.
	 */
