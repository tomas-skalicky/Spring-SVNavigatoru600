 ...
 */
@Controller
public class EditAccountingDocumentController extends AbstractEditDocumentController {

    @Inject
    public EditAccountingDocumentController(final OtherDocumentRecordService recordService,
            final SendNotificationEditModelFiller sendNotificationModelFiller, final EditRecordValidator validator,
            final MessageSource messageSource) {
        super(AccountingUrlParts.EXISTING_URL, new PageViews(), OtherDocumentRecordTypeEnum.ACCOUNTING, recordService,
                sendNotificationModelFiller, validator, messageSource);
    }

    @Override
    @GetMapping(value = AccountingUrlParts.EXISTING_URL + "{recordId}/")
    ...
    @Override
    @GetMapping(value = AccountingUrlParts.EXISTING_URL + "{recordId}/" + CommonUrlParts.SAVED_EXTENSION)
    ...
    @Override
    @PostMapping(value = AccountingUrlParts.EXISTING_URL + "{recordId}/")
