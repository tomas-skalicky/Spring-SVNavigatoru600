...
@Controller
public class NewAccountingDocumentController extends NewDocumentController {
	...
	public NewAccountingDocumentController(OtherDocumentRecordDao recordDao, NewRecordValidator validator,
		...
		super(NewAccountingDocumentController.BASE_URL, new PageViews(), OtherDocumentRecordType.ACCOUNTING, recordDao,
