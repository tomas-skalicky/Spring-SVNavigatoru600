...
public abstract class ListRecordsController extends SessionRecordController {
     ...
     * record's type.
     */
    private Map<SessionRecord, String> getLocalizedTypeTitles(List<SessionRecord> records,
     ...
     */
    private Map<SessionRecord, String> getLocalizedSessionDates(List<SessionRecord> records,
            HttpServletRequest request) {
