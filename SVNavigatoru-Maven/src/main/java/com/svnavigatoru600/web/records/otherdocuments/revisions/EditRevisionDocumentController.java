...
public class EditRevisionDocumentController extends AbstractEditDocumentController {
    ...
    public EditRevisionDocumentController(final OtherDocumentRecordService recordService,
        ...
        super(RevisionsUrlParts.EXISTING_URL, new PageViews(), OtherDocumentRecordTypeEnum.REGULAR_REVISION, recordService,
                sendNotificationModelFiller, validator, messageSource);
    }

    @Override
    @GetMapping(value = RevisionsUrlParts.EXISTING_URL + "{recordId}/")
    ...
    @Override
    @GetMapping(value = RevisionsUrlParts.EXISTING_URL + "{recordId}/" + CommonUrlParts.SAVED_EXTENSION)
    ...
    @Override
    @PostMapping(value = RevisionsUrlParts.EXISTING_URL + "{recordId}/")
