...
public class EditContractDocumentController extends AbstractEditDocumentController {
    ...
    @Inject
    public EditContractDocumentController(final OtherDocumentRecordService recordService,
            final SendNotificationEditModelFiller sendNotificationModelFiller, final EditRecordValidator validator,
            final MessageSource messageSource) {
        super(ContractsUrlParts.EXISTING_URL, new PageViews(), OtherDocumentRecordTypeEnum.CONTRACT, recordService,
                sendNotificationModelFiller, validator, messageSource);
    }

    @Override
    @GetMapping(value = ContractsUrlParts.EXISTING_URL + "{recordId}/")
    ...
    @Override
    @GetMapping(value = ContractsUrlParts.EXISTING_URL + "{recordId}/" + CommonUrlParts.SAVED_EXTENSION)
    ...
    @Override
    @PostMapping(value = ContractsUrlParts.EXISTING_URL + "{recordId}/")
