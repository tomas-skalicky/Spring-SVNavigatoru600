...
public class AuthorityUtils {
	...
	/**
	 * Gets an array of indicators which say which authorities (= roles) are
	 * checked (selected), and which authorities are not checked. The array is
	 * filled in according to the given array of checked
	...
	/**
	 * <p>
	 * Gets the default array of indicators which say which authorities (=
	 * roles) are checked (selected), and which authorities are not checked.
	 * </p>
	 * <b>Precondition:</b> Ordinal values of all {@link AuthorityType}s are
	 ...
	 * {@link Set} of {@link GrantedAuthority}s associated with an {@link User}
	 * with the given <code>username</code>.
	 * 
	 * @return Set of those authorities which have been checked, i.e. their
