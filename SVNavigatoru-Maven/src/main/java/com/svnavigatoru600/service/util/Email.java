 ...
 * <a href= "http://www.mkyong.com/java/javamail-api-sending-email-via-gmail-smtp-example/" >Mkyong</a>.
 *
...
public final class Email {
    ...
    /**
     * Sends an email with the given arguments; no matter which way of sending (i.e. SSL, TLS, or something else) is
     * used. <b>Precondition:</b> The function assumes that the given <code>recipient</code> represents a correct email
     * address.
     *
     * @param recipient
    ...
    private static void sendMail(String recipient, String subject, String messageText, int smtpPort) {
        ...
        LOGGER.info(String.format("Sending email to %s, smtpPort=%d, subject='%s', messageText='%s'", recipient,
                smtpPort, subjectWithDiacritics, messageText));
    ...
    /**
     * Sends an email with the given arguments without SSL protocol. <b>Precondition:</b> The function assumes that the
     * given <code>recipient</code> represents a correct email address.
     *
     * @param recipient
     *            Recipient's email address
     * @param smtpPort
    ...
    /**
     * Sends an email with the given arguments via SSL protocol. <b>Precondition:</b> The function assumes that the
     * given <code>recipient</code> represents a correct email address.
     *
     * @param recipient
     *            Recipient's email address
    ...
    /**
     * Sends an email with the given arguments via TLS/STARTTLS protocol. <b>Precondition:</b> The function assumes that
     * the given <code>recipient</code> represents a correct email address.
     *
     * @param recipient
     *            Recipient's email address
     */
    ...
    /**
     * Creates an email body which contents the given <code>messageText</code>. The MIME subtype is <code>html</code>.
     */
