...
public final class JspCodeGenerator {
     ...
     * @param request
     * @param subItems
     *            The array of information about sub-items of the root navigation item. Each sub-item is specified by an
     *            array of {@link String Strings} where on the first position there is a reference of the item and on
     *            the second position there is its title.
     */
    public static String getMainNavigationItem(String reference, String title, HttpServletRequest request,
            String[][] subItems) {
    ...
    /**
     * Gets the JSP code of an item of the main navigation. The code does not contain <code>&lt;li></code> tag.
     * 
     * @param reference
     *            The reference of the navigation item.
     * @param rootAddress
     ...
     * @param subItems
     *            The array of information about sub-items of the navigation item. Each sub-item is specified by an
     *            array of {@link String} s where on the first position there is a reference of the item and on the
     *            second position there is its title.
     */
    private static String getMainNavigationItem(String reference, String rootAddress, String title,
