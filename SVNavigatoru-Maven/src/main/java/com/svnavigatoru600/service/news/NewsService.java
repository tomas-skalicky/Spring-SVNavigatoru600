...
public class NewsService implements SubjectOfNotificationService {
    ...
    public List<News> findAllOrdered() {
        return this.newsDao.findAllOrdered(new FindAllOrderedArguments(NewsField.creationTime, OrderType.DESCENDING));
    }
    ...
    @Override
    public void notifyUsersOfUpdate(Object updatedNews, HttpServletRequest request, MessageSource messageSource) {
