...
<form:form action="IS_FILLED_BY_JAVASCRIPT" commandName="newEditEventCommand" method="POST">
	...
	<table>
		<tr>
			<td><form:label path="event.name">
					<spring:message code="event-calendar.name" />:</form:label>
			</td>
			<td><form:input path="event.name" autocomplete="${newEditEventCommand.event.name}" class="longText" />
			</td>
		</tr>
		<tr>
			<td><form:label path="event.date">
					<spring:message code="event-calendar.date" />:</form:label>
			</td>
		...
		<tr>
			<td><form:label path="event.description">
					<spring:message code="event-calendar.description" />:</form:label>
			</td>
			<td><form:textarea path="event.description" cols="20" rows="3" />*</td>
		</tr>
		<tr>
			<td><form:label path="newPriority">
					<spring:message code="event-calendar.priority" />:</form:label>
			</td>
			<td><ul>
