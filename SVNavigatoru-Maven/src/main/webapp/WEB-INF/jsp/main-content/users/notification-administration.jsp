...
<%-- IN_NEWS --%>
<spring:eval expression="T(com.svnavigatoru600.domain.users.NotificationTypeEnum).IN_NEWS.ordinal" var="subscribedTo" />
...
<%-- IN_EVENTS --%>
<spring:eval expression="T(com.svnavigatoru600.domain.users.NotificationTypeEnum).IN_EVENTS.ordinal" var="subscribedTo" />
<c:set var="checkboxTitle" value="${localizedNotificationCheckboxTitles[subscribedTo]}" />
...
<%-- IN_FORUM --%>
<spring:eval expression="T(com.svnavigatoru600.domain.users.NotificationTypeEnum).IN_FORUM.ordinal" var="subscribedTo" />
<c:set var="checkboxTitle" value="${localizedNotificationCheckboxTitles[subscribedTo]}" />
...
<%-- IN_OTHER_DOCUMENTS --%>
<spring:eval expression="T(com.svnavigatoru600.domain.users.NotificationTypeEnum).IN_OTHER_DOCUMENTS.ordinal" var="subscribedTo" />
<c:set var="checkboxTitle" value="${localizedNotificationCheckboxTitles[subscribedTo]}" />
...
<%-- IN_OTHER_SECTIONS --%>
<spring:eval expression="T(com.svnavigatoru600.domain.users.NotificationTypeEnum).IN_OTHER_SECTIONS.ordinal" var="subscribedTo" />
<c:set var="checkboxTitle" value="${localizedNotificationCheckboxTitles[subscribedTo]}" />
