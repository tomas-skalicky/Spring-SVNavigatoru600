...
<%
	...
	throw new RuntimeException("The tile 'sidebar' is determined only for the logged users.");
}



// The user is logged in; hence shows the sidebar.
if (UserUtils.getLoggedUser().canSeeNews()) {
%>
